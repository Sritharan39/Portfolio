...
export default function ThreeDPortfolio({ onBack }) {
  return (
    <div className="w-full min-h-screen flex items-center justify-center" style={{ backgroundColor: "var(--bg-primary)" }}>
      <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="text-center">
        ...
        <h1 className="text-5xl font-bold mb-4" style={{ color: "var(--text-primary)" }}>3D World Portfolio</h1>
        <p style={{ color: "var(--text-secondary)" }} className="mb-8">Immersive three-dimensional environment</p>
        <button
          onClick={onBack}
