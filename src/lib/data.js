export const personalInfo = {
  ...
  email: "sritharan@example.com",
  github: "https://github.com/Sritharan39",
  linkedin: "https://linkedin.com/in/sritharan",
  ...
  yearsExp: "3+",
  projectsBuilt: "20+",
  systemsIntegrated: "10+",
};

export const skills = [
  { category: "LIMS & Domain", items: ["SampleManager LIMS", "SDMS Integration", "Lab Workflows", "Sample Tracking", "Audit Trail"] },
  { category: "Frontend", items: ["React.js", "Next.js", "JavaScript", "HTML/CSS", "Tailwind CSS"] },
  { category: "Backend", items: ["Python", "SQL", "REST APIs", "Node.js"] },
  { category: "DevOps & Tools", items: ["Git", "GitHub", "Vercel", "VS Code", "Jira"] },
];
...
export const experiences = [
  {
    ...
    highlights: ["SampleManager LIMS customization", "SDMS & instrument integrations", "SQL report generation", "Lab workflow automation"],
  },
];
...
export const projects = [
  ...
  },
  {
    ...
    description: "This site — a precision-engineered personal showcase with award-level design standards and full animation orchestration.",
    status: "Live",
    year: "2025",
  },
];
